...
PERTINENCE PAR SECTEUR D'ACTIVITÉ : dans "secteurs", indique le ou les secteurs RÉELLEMENT et DIRECTEMENT concernés par l'article (parmi : sante, transport, energie, btp, numerique, environnement, social, eau, amenagement, culture, agriculture, regalien). Règle de SOBRIÉTÉ : 1 secteur en général, 2 au maximum, et seulement si le second est tout aussi central. N'ajoute JAMAIS un secteur simplement évoqué ou mentionné en passant. Exemples : un arrêt sur les aérodromes/SNCF/RATP → ["transport"] (et rien d'autre) ; un marché de travaux → ["btp"] ; une décision purement environnementale → ["environnement"] ; un sujet hospitalier → ["sante"] ; l'aide sociale aux personnes âgées → ["social"] ; une décision sur l'eau agricole → ["eau","agriculture"] si les deux sont au cœur du texte. Le secteur "regalien" est réservé au DROIT DES ÉTRANGERS : séjour, éloignement (OQTF, expulsion, reconduite), asile et protection internationale, rétention administrative, nationalité et naturalisation, regroupement familial, politique migratoire française et européenne. Ne l'attribue PAS aux sujets de sécurité, d'ordre public ou de police administrative qui ne concernent pas les étrangers. Les régulateurs sectoriels (ART = transports, ANSSI/CNIL = numérique) ne portent JAMAIS d'autre secteur que le leur. Mets [] si l'article est procédural ou général sans ancrage sectoriel net (élections, actes administratifs, contentieux de la fonction publique générale, etc.).
